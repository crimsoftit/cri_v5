...
import 'package:cri_v5/features/store/screens/home/widgets/store_summary_card.dart';
                ...
                children: [
                  ...
                  CStoreSummaryCard(
                    ...
                    subTitleTxtColor: txnsController.netProfit.value >= 0
                        ? CColors.rBrown
                        : CColors.error,
                    titleTxt: txnsController.netProfit.value.toStringAsFixed(
                      2,
                    ),
              ...
              Row(
                ...
                children: [
                  ...
                  CStoreSummaryCard(
                    ...
                    titleTxt: txnsController.onTheHauzSales.value
                        .toStringAsFixed(1),
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  CStoreSummaryCard(
                    ...
                    // subTitleTxt: 'money collected($userCurrency)',
                    subTitleTxt:
                        'expired(${invController.expiredItems.length})',
